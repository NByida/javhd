package com.azul.yida.javhd.view.viewHelper;
...
public class BGArefreshView extends BGAStickinessRefreshView {
    ...
    public BGArefreshView(Context context) {
        this(context, null);
    }

    public BGArefreshView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BGArefreshView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initSize() {
        mEdge = BGARefreshLayout.dp2px(getContext(), 0);
        mRotateDrawableSize = BGARefreshLayout.dp2px(getContext(), 30);
        mTopSize = mRotateDrawableSize;
        //mRotateDrawableSize + 2 * mEdge;

        mMaxBottomHeight = mRotateDrawableSize;
        //(int) (2.4f * mRotateDrawableSize);
    }
